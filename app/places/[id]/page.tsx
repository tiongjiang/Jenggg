        ...
        <div className="flex items-center justify-between">
          ...
          {isAdmin && (
            <button
              ...
              className="bg-bau-blue text-white border-[2.5px] border-bau-black font-baloo font-extrabold text-xs px-4 py-2 rounded-xl shadow-bau-sm active:scale-95 transition-transform"
            >
              ✏️ Edit Spot
            </button>
          )}
