...
export default function LeafletMapComponent({ places }: MapProps) {
  ...
  return (
    <div className="w-full h-full relative">
      ...
      >
        ...
        <Marker position={userPos} icon={createUserTrainerIcon()}>
          <Popup className="bauhaus-leaflet-popup font-baloo font-bold" closeButton={false}>
            <div className="bg-bau-black text-bau-yellow border-2 border-bau-yellow rounded-xl px-3 py-1.5 shadow-bau text-xs">
        ...
        {places.map((place) => {
          ...
          const officialBadge = getRatingBadge(place.current_tier, place.is_requested);
                  ...
                  <div className="p-3">
                    ...
                    <div className="grid grid-cols-2 gap-1.5 mb-2">
                      ...
                      <div className="bg-white p-1.5 rounded-lg border border-bau-black text-bau-black">
                        <span className="block text-[8px] font-space tracking-wider text-gray-500 font-bold">Hunters</span>
                    ...
                    <button
                      ...
                      className="w-full bg-bau-black text-bau-cream border-[2px] border-bau-black py-2 rounded-xl font-baloo font-extrabold text-xs shadow-bau-sm active:translate-x-0.5 active:translate-y-0.5"
                    >
                      View Full Verdict →
                    </button>
                  </div>
      ...
      <button
        onClick={locateMe}
        className="absolute bottom-5 left-3.5 z-30 w-11 h-11 rounded-full bg-bau-cream border-[2.5px] border-bau-black shadow-bau flex items-center justify-center text-lg active:translate-x-0.5 active:translate-y-0.5 transition-transform"
        title="Recenter GPS"
      >
        📍
      </button>
